...
export const Services: React.FC = () => {
      ...
      sectionRefs.current.forEach((section, idx) => {
        ...
        ScrollTrigger.create({
          ...
          onToggle: (self) => {
            ...
            } else if (idx === services.length - 1 && self.progress === 1) {
              setActiveService(-1);
            }
          },
        });
  ...
  return (
    <div
      className="w-full bg-transparent select-none overflow-x-hidden relative font-sans"
          ...
          if (service.layout === 'hero') {
            ...
            return (
              <section
                ...
                className={`relative w-full px-6 md:px-12 xl:pl-32 ${service.spacing} overflow-visible ${idx % 2 === 0 ? 'bg-white' : 'bg-transparent'}`}
              >
