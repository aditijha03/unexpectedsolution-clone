...
export const DesktopHero: React.FC = () => {
  ...
  return (
    <section id="solutions-hero" className="relative min-h-[750px] h-screen w-full bg-transparent flex items-center pt-[135px] pb-12 px-8 overflow-hidden select-none">
